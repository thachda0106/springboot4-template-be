...
Usage:
  python scripts/mint-local-jwt.py --sub <user-id> [--role ADMIN] [--scope prometheus] [--secret SECRET] [--exp-hours 1]
...
Examples:
  ...
  python scripts/mint-local-jwt.py --sub scraper-1 --scope prometheus
"""
