    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/activities/**").hasAuthority("SCOPE_activity:write")
                        .requestMatchers(HttpMethod.PUT, "/api/activities/**").hasAuthority("SCOPE_activity:write")
                        .requestMatchers(HttpMethod.DELETE, "/api/activities/**").hasAuthority("SCOPE_activity:admin")
                        .requestMatchers(HttpMethod.GET, "/api/workflow-entries/**").authenticated()
